 ...
 * @Date: 2022-02-25 16:05
 * @Since:
 */
package com.zja.controller;

import com.mongodb.client.result.DeleteResult;
import com.zja.model.ShopDTO;
...
@Api(tags = {"MongoTemplateController"}, description = "Mongodb 文档操作")
@RestController
...
public class MongoTemplateController {
    ...
    public Object saveShop(@ApiParam(value = "具体参考：Model") @RequestBody ShopDTO shopDTO) {
        ...
        List<ShopDTO> shopDTOList = mongoTemplate.findAll(ShopDTO.class, "shops");

...
//
//    //已弃用, ElasticsearchTemplate不推荐使用了
////    @Autowired
...
//        // 2、填入class对象创建索引
//        //boolean indexRes = elasticsearchRestTemplate.createIndex(BookEntity.class);
...
//
//       /* elasticsearchRestTemplate.save(bookEntity);
//
...
//        return bookRepository.searchSimilar(new BookEntity(), content, PageRequest.of(page, size));
//    }*/
//
...
//        SearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(QueryBuilders.queryStringQuery(content)).withPageable(PageRequest.of(page, size)).build();
//        return elasticsearchRestTemplate.queryForList(searchQuery, BookEntity.class);
//    }*/
//

 ...
 * ws://127.0.0.1:8080/webroot/ws/server/{userId}/{meetingId}
 */
@Slf4j
@Component
@ServerEndpoint("/ws/server/{userId}/{meetingId}")  // 类似 @RequestMapping
...
//        this.sendMessageByUserId(message, meetingId, userId);
    ...
    public ConcurrentHashMap<String, UserWsServerEndpoint> getWebSocketMap() {
        return webSocketMap;
    }
}

...
import com.zja.stompwebsocket.config.StompWebSocketConfig;
...
//    @Scheduled(fixedRate = 5000)
     ...
     * 群聊：此方法用于群发测试
     *
     * 注解 @MessageMapping 类似 @RequestMapping 其中，"/massRequest" 为 {@link StompWebSocketConfig#configureMessageBroker}方法配置的
     *
     * @param msg
     * @return
     */
